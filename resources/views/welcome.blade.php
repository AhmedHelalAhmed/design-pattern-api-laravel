            ...
            <div class="grid grid-cols-1 md:grid-cols-2">
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://laravel.com/docs"
                                                                             class="underline text-gray-900 dark:text-white">Creational</a>
                        </div>
                    </div>
                    ...
                    <div class="ml-12">
                        @foreach($creationPatterns as $pattern)
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                <a href="{{ $pattern['link'] }}" class="underline">{{ $pattern['name'] }}</a>
                            </div>
                        @endforeach
                    </div>
                </div>
                ...
                <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://laracasts.com"
                                                                             class="underline text-gray-900 dark:text-white">Structural</a>
                        </div>
                    </div>
                ...
                <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://laravel-news.com/"
                                                                             class="underline text-gray-900 dark:text-white">Behavioral</a>
                        </div>
                    </div>
                ...
                <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white">More</div>
                    </div>

                    <div class="ml-12">
                        @foreach($morePatterns as $pattern)
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                <a href="{{ $pattern['link'] }}" class="underline">{{ $pattern['name'] }}</a>
                            </div>
                        @endforeach
        ...
        <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
            <div class="text-center text-sm text-gray-500 sm:text-left">
                <div class="flex items-center">
                    ...
                    <a href="https://github.com/AhmedHelalAhmed" class="ml-1 underline">Ahmed Helal</a>
                </div>
            </div>
